...
class EmployeeCriteriaTest {
    ...
    private static void setAllFilters(EmployeeCriteria employeeCriteria) {
        ...
        employeeCriteria.specialization();
        employeeCriteria.serviceProviderId();
        employeeCriteria.servicesForCustomerId();
        employeeCriteria.servicesId();
    ...
    private static Condition<EmployeeCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getServicesForCustomerId()) &&
                condition.apply(criteria.getServicesId()) &&
    ...
    private static Condition<EmployeeCriteria> copyFiltersAre(EmployeeCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getServicesForCustomerId(), copy.getServicesForCustomerId()) &&
                condition.apply(criteria.getServicesId(), copy.getServicesId()) &&
